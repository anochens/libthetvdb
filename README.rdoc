...
==To turn on pretty format (will make much slower, but better formatted)
===This turns ["EpisodeName"] into "EpisodeName" and ["|actor1|actor2|" into ["actor1","actor2"]
...
===Use this, it has the same result as infoForSeriesId() followed by getAllEpisodes() , but it is better to use this instead, because it is more efficient.
<tt>
...
==To search for shows by name use this. 
===Keep in mind that multiple things are returned
